...
**배포 URL**: https://여기에-배포된-주소를-넣으세요.vercel.app
...
| 정답 가리기 | 정답과 해설은 기본으로 접혀 있어 인출 연습을 강제 |
...
Vercel Serverless Function (api/quiz.py)
    ...
    │  ④ 프롬프트 구성 후 OpenAI API 호출 (타임아웃 45초)
    ▼
...
| 응답 지연 | 프론트 25초 / 백엔드 45초 | 504 | 응답이 25초를 넘었습니다. 노트나 문제 수를 줄여 주세요. |
